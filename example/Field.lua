...
local TestField = Class("TestField")
-- 获取Class构建器
local builder = TestField.builder
...
-- 测试
local mTestField = TestField()
TestField.field = 1
mTestField.field = 2
print(TestField.field)
print(mTestField.field)